...
bindsym $mod+a workspace $ws8
bindsym $mod+o workspace $ws9
bindcode $mod+25 workspace $ws10
bindcode $mod+24 workspace $ws7
...
bindsym $mod+Shift+a move container to workspace $ws8
bindsym $mod+Shift+o move container to workspace $ws9
bindcode $mod+Shift+25 move container to workspace $ws10
bindcode $mod+Shift+24 move container to workspace $ws7
